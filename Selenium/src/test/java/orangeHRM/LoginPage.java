...
public class LoginPage {
	...
	public static void main(String[] args) {
		...
		//file upload
		WebElement selectResumeupload=driver.findElement(By.xpath("//div[@class='oxd-file-button']"));
		selectResumeupload.click();
		wait.until(ExpectedConditions.visibilityOf(selectResumeupload));
		...
		//Vacancy tab -top menu item
		WebElement vacancybutton=driver.findElement(By.xpath("//a[@ui-sref='recruitment.vacancies']"));
		vacancybutton.click();
